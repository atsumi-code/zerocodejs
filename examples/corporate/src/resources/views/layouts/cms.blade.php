...
<body>
    <nav>
        <div class="container">
            ...
            <a href="{{ route('cms.page.edit', 'default') }}">トップ</a>
            <a href="{{ route('cms.page.edit', 'about') }}">会社概要</a>
            <a href="{{ route('cms.page.edit', 'services') }}">事業内容</a>
            <a href="{{ route('cms.news.index') }}">新着情報</a>
            <a href="{{ route('cms.news.create') }}">新規記事</a>
